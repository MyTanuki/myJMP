...
INSERT INTO "new_User" ("createdAt", "dormName", "elecRate", "email", "id", "name", "passwordHash", "waterRate") SELECT "createdAt", "dormName", "elecRate", "email", "id", "name", "passwordHash", "waterRate" FROM "User";
DROP TABLE "User";
